...
space = st.sidebar.slider("Coordinate Size", min_value=10, max_value=100, value=15, step=5)
resolution = st.sidebar.slider("Coordinate Resolution", min_value=10, max_value=200, value=50, step=2)
